...
pc.highlightedColors = function(colors){
	if(typeof colors === 'undefined' || colors == null || colors.length == 0){
		return __.highlightedColors;
	} else
		__.highlightedColors = colors;
}

function path_highlight(d, i) {
	if(i<__.highlightedColors.length){
		ctx.highlight.strokeStyle = __.highlightedColors[i];
	} else {
...
pc.highlight = function(data) {
  if (arguments.length === 0 || data.length === 0) {
